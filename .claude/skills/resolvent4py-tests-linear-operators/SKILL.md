...
| [test_matrix_exponential.py](../../../tests/linear_operators/test_matrix_exponential.py) | `MatrixExponentialLinearOperator` | RK2 vs RK3 accuracy bands; uses `square_stable_random_matrix` |
...
| `MatrixExponential` (RK3, `dt=1e-5`, `tf=2.1`) | `1e-11` |
| `MatrixExponential` (RK2, same params) | `1e-7` |
